...
#    plt.grid(True,which='major',color="black",linewidth="1",linestyle="-")
#    plt.minorticks_on()
#    plt.grid(True,which='minor',color="black",linestyle="-")
